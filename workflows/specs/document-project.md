...
Creates structured documentation in `{documentation_dir}/`:
...
**If starting fresh:**
- Archive old state to `{documentation_dir}/.archive/project-scan-report-[timestamp].json`
- Proceed to Step 2
...
Create `{documentation_dir}/project-scan-report.json`:
...
>
> **Files to create in `{documentation_dir}/`:**
>
...
- Output: `{documentation_dir}/index.md` and [N] related files
...
```bash
cat {documentation_dir}/index.md
cat {documentation_dir}/project-overview.md
cat {documentation_dir}/source-tree.md
```
...
**Generated:** `{documentation_dir}/deep-dive-[target_name].md`
...
**Index Updated:** `{documentation_dir}/index.md` now includes link to this deep-dive
...
`{documentation_dir}/project-scan-report.json`:
