...
- Search for product brief: `{output_folder}/*brief*.md` or `{output_folder}/*brief*/index.md` (sharded)
- Search for research: `{output_folder}/*research*.md` or `{output_folder}/*research*/index.md` (sharded)
- Search for brainstorming: `{output_folder}/*brainstorm*.md` or `{output_folder}/*brainstorm*/index.md` (sharded)
...
**Save product brief** to `{output_folder}/product-brief-{project_name}-{date}.md`
...
3. Update: `workflow_status["product-brief"] = "{output_folder}/product-brief-{project_name}-{date}.md"`
...
**Document saved:** {output_folder}/product-brief-{project_name}-{date}.md
...
**1. Product Brief** (`{output_folder}/product-brief-{project_name}-{date}.md`)
...
```yaml
workflow_status:
  product-brief: "{output_folder}/product-brief-{project_name}-{date}.md"  # ← Updated
```
