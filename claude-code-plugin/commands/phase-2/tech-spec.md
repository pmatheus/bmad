...
**Context:**
- Tech-spec: {output_folder}/tech-spec.md (comprehensive, context-rich)
...
- {output_folder}/sprint_artifacts/story-{epic-slug}-1.md
- {output_folder}/sprint_artifacts/story-{epic-slug}-2.md (if story_count >= 2)
...
3. Update: `workflow_status["tech-spec"] = "{output_folder}/tech-spec.md"`
...
**1. Tech-Spec** (`{output_folder}/tech-spec.md`)
```markdown
...
```yaml
workflow_status:
  tech-spec: "{output_folder}/tech-spec.md"  # ← Updated
```
