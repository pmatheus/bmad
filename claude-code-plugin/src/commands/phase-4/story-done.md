...
**Variables needed:**
- `output_folder`: Where sprint-status.yaml is located
...
1. Load COMPLETE file: `{output_folder}/sprint-status.yaml`
...
cat {output_folder}/sprint-status.yaml
```
...
```yaml
output_folder: "docs/bmad"                # Where sprint-status.yaml is located
...
**2. Sprint Status** (`{output_folder}/sprint-status.yaml`)
```yaml
development_status:
